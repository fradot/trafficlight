...
public class TrafficLightDatabaseSchedulingIT {
  ...
  public void itShouldLoadADefaultConfigurationFromTheDatabase() {
    ...
    TrafficLightConfiguration trafficLightConfigurationActual =
        trafficLightConfigurationQueue.peek();
  ...
  @DisplayName(
      "It should trigger the transition according to the configuration with the highest priority.")
  @Order(3)
  @Test
