...
class TrafficLightTaskEnablingAtRuntimeIT {
    ...
    public void itShouldScheduleANewConfigurationCreatedAtRuntime() throws Exception {
        ...
        TrafficLightConfiguration trafficLightConfiguration =
                new TrafficLightConfiguration(5L, 20L, 16L, 21L, "0/1 * * 1/1 * ?", null, 5, false, false, true, false);
        TrafficLightConfiguration newlyCreatedConfiguration =
                trafficLightConfigurationRepository.save(trafficLightConfiguration);
        ...
        await().between(19500, TimeUnit.MILLISECONDS, 20500, TimeUnit.MILLISECONDS)
                .and()
